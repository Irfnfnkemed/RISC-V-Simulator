...
void reservation_station::add_instruction(u_int8_t instr_, int value_one_, int value_two_,
                                          int depend_one_, int depend_two_, int imd_, int tag_) {
    int index = 0;
    while (buffer[index].instr != 0xff) { ++index; }
